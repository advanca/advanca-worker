...
extern "C" {
    ...
    pub fn get_worker_sr25519_pubkey (eid: sgx_enclave_id_t, retval: *mut sgx_status_t, ubuf: *mut u8, ubuf_size: *mut usize) -> sgx_status_t;
    pub fn get_task_sr25519_pubkey (eid: sgx_enclave_id_t, retval: *mut sgx_status_t, ubuf: *mut u8, ubuf_size: *mut usize, task_id: *const u8) -> sgx_status_t;
